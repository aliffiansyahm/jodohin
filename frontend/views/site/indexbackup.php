            ...
            <ul class="left-menu">
                <li>
                    <a href="#" class="js-sidebar-open">
                        <svg class="olymp-menu-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="OPEN MENU"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-menu-icon"></use></svg>
                    </a>
                </li>
                <li>
...
<div class="container">
    <div class="row">
        ...
        <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active inline-items" data-toggle="tab" href="#home-1" role="tab" aria-expanded="true">
                                ...
                                <svg class="olymp-status-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-status-icon"></use></svg>
                        ...
                        <li class="nav-item">
                            <a class="nav-link inline-items" data-toggle="tab" href="#profile-1" role="tab" aria-expanded="false">
                                ...
                                <svg class="olymp-multimedia-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-multimedia-icon"></use></svg>
                        ...
                        <li class="nav-item">
                            <a class="nav-link inline-items" data-toggle="tab" href="#blog" role="tab" aria-expanded="false">
                                <svg class="olymp-blog-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-blog-icon"></use></svg>
                            ...
                            <form>
                                ...
                                <div class="add-options-message">
                                    <a href="#" class="options-message" data-toggle="tooltip" data-placement="top"   data-original-title="ADD PHOTOS">
                                        <svg class="olymp-camera-icon" data-toggle="modal" data-target="#update-header-photo"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-camera-icon"></use></svg>
                                    </a>
                                    ...
                                    <a href="#" class="options-message" data-toggle="tooltip" data-placement="top"   data-original-title="ADD LOCATION">
                                        <svg class="olymp-small-pin-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-small-pin-icon"></use></svg>
                                    </a>
                    ...
                    <article class="hentry post video">
                        ...
                        <div class="post-video">
                            <div class="video-thumb">
                                ...
                                <a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video">
                                    <svg class="olymp-play-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-play-icon"></use></svg>
                                </a>
                            </div>
                        ...
                        <div class="post-additional-info inline-items">
                            ...
                            <div class="comments-shared">
                                <a href="#" class="post-add-icon inline-items">
                                    <svg class="olymp-speech-balloon-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-speech-balloon-icon"></use></svg>

                                    <span>0</span>
                                </a>

                                <a href="#" class="post-add-icon inline-items">
                                    <svg class="olymp-share-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-share-icon"></use></svg>
                        ...
                        <div class="control-block-button post-control-button">
                            ...
                            <a href="#" class="btn btn-control">
                                <svg class="olymp-like-post-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-like-post-icon"></use></svg>
                            </a>
                    ...
                    <ul class="comments-list">
                        <li class="comment-item">
                            <div class="post__author author vcard inline-items">
                                ...
                                <a href="#" class="more"><svg class="olymp-three-dots-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg></a>
            ...
            <a id="load-more-button" href="#" class="btn btn-control btn-more" data-load-link="items-to-load.html" data-container="newsfeed-items-grid"><svg class="olymp-three-dots-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg></a>
            ...
            <div class="ui-block">
                ...
                <div class="widget w-wethear">
                    ...
                    <div class="wethear-now inline-items">
                        ...
                        <svg class="olymp-weather-partly-sunny-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-partly-sunny-icon"></use></svg>
                    </div>
                    ...
                    <ul class="weekly-forecast">
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-sunny-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-sunny-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-cloudy-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-cloudy-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-rain-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-rain-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-storm-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-storm-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-snow-icon"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-snow-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-wind-icon-header"><use xlink:href="olympus/svg-icons/sprites/icons-weather.svg#olymp-weather-wind-icon-header"></use></svg>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingOne-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne-1">
                                                Breakfast at the Agency<svg class="olymp-dropdown-arrow-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
                                    ...
                                    <div id="collapseOne-1" class="collapse" role="tabpanel" >
                                        ...
                                        <div class="place inline-items">
                                            <svg class="olymp-add-a-place-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-add-a-place-icon"></use></svg>
                                    ...
                                    <div class="card-header" role="tab" id="headingTwo-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
                                                Send the new “Olympus” project files to the Agency<svg class="olymp-dropdown-arrow-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
                ...
                <ul class="widget w-friend-pages-added notification-list friend-requests">
                    <li class="inline-items">
                        ...
                        <span class="notification-icon" data-toggle="tooltip" data-placement="top" data-original-title="ADD TO YOUR FAVS">
							<a href="#">
								<svg class="olymp-star-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-star-icon"></use></svg>
							</a>
						</span>
            ...
            <div class="ui-block">
                ...
                <div class="widget w-birthday-alert">
                    <div class="icons-block">
                        <svg class="olymp-cupcake-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-cupcake-icon"></use></svg>
                        <a href="#" class="more"><svg class="olymp-three-dots-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg></a>
                    </div>

		...
		<div class="header--standard-wrap">
			...
			<a href="#" class="logo">
				<div class="img-wrap">
					...
					<img src="olympus/img/logo-colored-small.png" alt="Olympus" class="logo-colored">
				</div>
								...
								<ul>
									<li class="cart-product-item">
										<div class="product-thumb">
											<img src="olympus/img/product1.png" alt="product">
										</div>
									...
									<li class="cart-product-item">
										<div class="product-thumb">
											<img src="olympus/img/product2.png" alt="product">
										</div>
										<div class="product-content">
			...
			<div class="registration-login-form">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#home" role="tab">
							<svg class="olymp-login-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-login-icon"></use></svg>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#profile" role="tab">
							<svg class="olymp-register-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-register-icon"></use></svg>
						</a>
					</li>
				</ul>
				...
				<div class="tab-content">
							...
							<div class="row">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<div class="form-group date-time-picker label-floating">
										...
										<input name="datetimepicker" value="1984/02/01" >
										<span class="input-group-addon">
											<svg class="olymp-calendar-icon"><use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-calendar-icon"></use></svg>
										</span>
									</div>
					...
					<div class="tab-pane" id="profile" role="tabpanel" data-mh="log-tab">
						...
						<form class="content" method="post" action="../web/pengguna/login">
							<div class="row">
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="form-group label-floating is-empty">
										<label class="control-label">Your Email</label>
